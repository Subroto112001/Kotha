      ...
      <div className="mt-[30px]">
        <div className="flex flex-row justify-between">
          <div>
            <h3
              className={`${
                theme == "day" ? "text-textgray " : "text-white"
          ...
          <div className="flex flex-col gap-2.5">
            <div className="flex flex-col gap-3">
              <textarea
                className="w-[400px] h-[200px] rounded bg-white p-3 border border-inputoutline"
                type="text"
                placeholder="Share your ideas!"
              />
              <button
                className={`bg-buttonblue py-3 text-[16px] font-medium text-white cursor-pointer`}
              >
                Post
              </button>
            </div>
            <div className="flex flex-col gap-2.5">
              <NavLink
                to={"/friends/suggetions"}
                className={`font-medium flex flex-row items-center gap-1.5 ${theme =="day"? "text-black": "text-white"} `}
              >
                <span>
                  <MdKeyboardDoubleArrowRight />
                </span>
